...
const EXPENSE_CATEGORIES = [
  ...
  { key: 'financialCosts', category: 'Financial Costs', description: 'Mortgage interest, overdraft fees, and other loan or finance costs (not capital repayments).' },
  ...
  { key: 'residentialFinancialCost', category: 'Residential Financial Cost', description: 'Tax relief on finance costs (restricted amount deductible from rental income).' },
  ...
  { key: 'residentialFinancialCostsCarriedForward', category: 'Residential Financial Costs Carried Forward', description: 'Unrelieved residential finance costs brought forward to future years.' },
